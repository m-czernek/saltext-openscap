# Salt Extension for Openscap

Salt Extension for interacting with Openscap
...
The saltext-openscap project welcomes contributions from anyone!
...
```bash
# Clone the repo
git clone --origin upstream git@github.com:m-czernek/saltext-openscap.git
...
* Writing blog posts
* Sharing your experiences using Salt + Openscap
  on social media
...
[PRs]: https://github.com/m-czernek/saltext-openscap/pulls
[discussions]: https://github.com/m-czernek/saltext-openscap/discussions
